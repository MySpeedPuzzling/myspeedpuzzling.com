 ...
 *
 * The matching inline script in base.html.twig hides the banner before first
 * paint on later page loads - this controller only handles the click.
 */
export default class extends Controller {
    static STORAGE_KEY = 'sign-in-changes-notice-dismissed';
