# Subject: Community Players

Illustration showing the social/community aspect of speed puzzling.
...
Create an illustration showing three people sitting around a table, each working on their own jigsaw puzzle. Small stopwatches sit next to each person. Their expressions show friendly concentration and competition. Puzzle pieces are scattered on the table between them.

Aspect ratio: 16:9 landscape, suitable for a website section illustration.
```
