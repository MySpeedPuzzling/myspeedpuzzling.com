# Subject: Competition Organizer Hero

Hero illustration for the "For Organizers" landing page, displayed in the right column of the hero section.
...
A cheerful organizer figure stands confidently in the center, holding a clipboard in one hand and gesturing toward a large countdown stopwatch display behind them. In the foreground, a long table with two seated participants is visible, each assembling colorful jigsaw puzzle pieces — partially completed puzzles sit on the table surface. To the side, an open laptop shows a simplified dashboard interface with round badges and a participant list. Scattered jigsaw puzzle pieces in coral-pink and sky-blue float decoratively around the edges of the composition. A small trophy icon and a checkmark badge accent the top corner, reinforcing the competition theme. Speed lines radiate from the stopwatch to convey energy and excitement.
