# Subject: Puzzle Assembly (Hero)

Website hero illustration showing the core activity — speed puzzling.
...
Create an illustration showing a jigsaw puzzle being assembled on a table. A stopwatch sits beside the puzzle showing time ticking. Several loose puzzle pieces are scattered around the partially completed puzzle. One or two pieces appear mid-air as if being placed. The scene captures the excitement and focus of competitive timed puzzle solving.

Aspect ratio: 16:9 landscape, suitable for a website hero section.
```
