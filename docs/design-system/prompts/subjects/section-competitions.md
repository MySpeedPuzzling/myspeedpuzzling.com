# Subject: Competitions section

Feature-section image for the competitions & events band.
...
Subject: A speed puzzling competition moment: two simple tables side by side, each with a person seated behind an almost-complete jigsaw puzzle (each puzzle with exactly ONE piece-shaped hole), both reaching to place their final piece at the same time. Between the tables a small standing sign with a stopwatch icon. A string of tiny triangular bunting flags (coral, sky-blue, lavender) hangs above. Short navy speed dashes behind both moving hands.
