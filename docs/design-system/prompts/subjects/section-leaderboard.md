...
Feature-section image for the leaderboards band.
...
Subject: A friendly competition podium scene: a three-step podium (coral first place, sky-blue second, lavender third) with a simple gold-outlined trophy on the top step holding one single oversized coral puzzle piece upright like a medal. Behind the podium, a tall simple leaderboard panel with three rows (round avatar circle + horizontal bar each, first row highlighted coral). A few tiny confetti dots and short navy dashes for energy.
