# Subject: Puzzle Database section

Feature-section image for the puzzle-database band.
...
Subject: A tidy stack of four jigsaw puzzle boxes in different sizes (lids showing simple abstract landscape art in coral, sky-blue, lavender and teal), with a large magnifying glass leaning against the stack, its lens highlighting one single oversized coral puzzle piece resting in front of the boxes. A small tag on the top box shows '1000'. No loose piece piles — just the boxes, the glass and that one piece.
