# Subject: Track Your Times section

Feature-section image for the time-tracking band.
...
Subject: A cozy desk scene about tracking puzzle solve times: a smartphone standing upright showing a big running timer (large navy digits, coral accent ring), next to an almost-finished jigsaw puzzle with exactly ONE piece-shaped hole and the matching sky-blue piece lying beside it. A small notebook with a simple rising line chart peeks from the corner. Short navy motion dashes near the phone's timer suggest ticking time.
