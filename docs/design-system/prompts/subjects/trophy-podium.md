# Subject: Trophy Podium

Leaderboard or competition result illustration.
...
Create an illustration of a podium (1st, 2nd, 3rd place) with jigsaw puzzle pieces incorporated into the podium design. A small stopwatch icon sits on top of the first-place position. Small decorative stars and confetti surround the podium.

Aspect ratio: 4:3, suitable for a feature section illustration.
```
