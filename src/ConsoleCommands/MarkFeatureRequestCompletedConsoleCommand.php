...
#[AsCommand('myspeedpuzzling:feature-request:completed')]
final class MarkFeatureRequestCompletedConsoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf('Feature request %s marked as completed.', $featureRequestId));
