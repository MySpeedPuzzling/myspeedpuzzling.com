...
#[AsCommand('myspeedpuzzling:feature-request:in-progress')]
final class MarkFeatureRequestInProgressConsoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf('Feature request %s marked as in progress.', $featureRequestId));
