...
final class NewPuzzleDetailController extends AbstractController
{
    ...
    #[Route(
        path: [
            'cs' => '/new-puzzle-detail/{puzzleId}',
            'en' => '/en/new-puzzle-detail/{puzzleId}',
        ],
        name: 'new_puzzle_detail',
    )]
    public function __invoke(string $puzzleId, #[CurrentUser] UserInterface|null $user, Request $request): Response
    {
        ...
        return $this->render('new_puzzle_detail.html.twig', [
            'puzzle' => $puzzle,
