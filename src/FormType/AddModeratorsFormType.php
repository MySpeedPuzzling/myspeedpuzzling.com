 ...
 *
 * @extends AbstractType<AddModeratorsFormData>
 */
final class AddModeratorsFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add('players', TextType::class, [
            'label' => 'admin.moderators.add_label',
            'help' => 'admin.moderators.add_help',
            'required' => false,
            'autocomplete' => true,
            'tom_select_options' => [
                'create' => false,
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => AddModeratorsFormData::class,
        ]);
    }
}
