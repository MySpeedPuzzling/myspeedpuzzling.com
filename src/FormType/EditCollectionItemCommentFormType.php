...
/**
 * @extends AbstractType<EditCollectionItemCommentFormData>
 */
final class EditCollectionItemCommentFormType extends AbstractType
{
    /**
     * @param mixed[] $options
     */
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => EditCollectionItemCommentFormData::class,
        ]);
    }
}
