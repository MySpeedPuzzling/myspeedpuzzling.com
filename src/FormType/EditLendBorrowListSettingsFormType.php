...
/**
 * @extends AbstractType<EditLendBorrowListSettingsFormData>
 */
final class EditLendBorrowListSettingsFormType extends AbstractType
{
    /**
     * @param mixed[] $options
     */
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => EditLendBorrowListSettingsFormData::class,
        ]);
    }
}
