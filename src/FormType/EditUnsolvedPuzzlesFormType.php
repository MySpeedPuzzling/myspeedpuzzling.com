...
final class EditUnsolvedPuzzlesFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder->add('visibility', ChoiceType::class, [
            'label' => 'unsolved_puzzles.form.visibility',
            'required' => true,
            'expanded' => true,
            'choices' => [
                'unsolved_puzzles.form.visibility_public' => CollectionVisibility::Public,
                'unsolved_puzzles.form.visibility_private' => CollectionVisibility::Private,
            ],
        ]);
    }
