...
SELECT
    ...
    CASE WHEN source_p.hide_image_until IS NOT NULL AND source_p.hide_image_until > NOW() THEN NULL ELSE source_p.image_ratio END AS source_puzzle_image_ratio,
    ...
    CASE WHEN survivor_p.hide_image_until IS NOT NULL AND survivor_p.hide_image_until > NOW() THEN NULL ELSE survivor_p.image_ratio END AS survivor_puzzle_image_ratio,
