...
/**
 * The e-mailed "delete my account" token: 64 hex chars, selector + verifier
 * (mirrors PasswordResetToken; see AccountDeletionRequest for why it is split).
 */
final readonly class AccountDeletionToken
{
