...
final class DenyConversationHandlerTest extends KernelTestCase
{
    ...
    public function testDenyingConversationChangesStatusToDenied(): void
    {
        // CONVERSATION_PENDING: WITH_STRIPE (initiator) → REGULAR (recipient)
        $this->messageBus->dispatch(
            new DenyConversation(
        ...
        self::assertSame(ConversationStatus::Denied, $conversation->status);
        self::assertNotNull($conversation->respondedAt);
    }

    public function testOnlyRecipientCanDeny(): void
    {
        try {
